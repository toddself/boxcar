...
const data = [
  {id: shortid.generate(), test1: 'test', test2: 'got', test3: 'a', test4: 'friend', test5: 'her', test6: 'name'},
  {id: shortid.generate(), test1: 'foo', test2: 'boxcar', test3: 'cigarettes', test4: 'and', test5: 'beer', test6: 'in el sob'}
]
